...
const Home = () => {
  ...
  <div className="flex h-full w-full flex-col items-center justify-center gap-6 rounded-4xl border-black bg-[#436850] px-4 py-6 md:p-2 text-center">
    ...
    <img src="/OurStory4-removebg-preview.png" className="bg-image" alt="background" />
          ...
          <div className="col-start-1 col-end-2 md:row-span-3 bg-[#FDCB9E] border rounded-3xl p-5 content-center hidden sm:block">
